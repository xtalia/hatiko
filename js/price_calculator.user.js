...
(function() {
    ...
    function createCalculator() {
        ...
        title.textContent = '🧮 Калькулятор 1.5.5';
        ...
        function calculate() {
            ...
            if (mode === 'all') {
                qr_price = Math.round(cash * 1.0405 / 100) * 100 - 10;
                card_price = Math.round(cash * 1.0505 / 100) * 100 - 10;
                rassrochka_price_six = Math.round(cash * 1.1005 / 100) * 100 - 10;
                rassrochka_price_ten = Math.round(cash * 1.1305 / 100) * 100 - 10;
                credit_price = Math.round(cash * 1.2005 / 100) * 100 - 10;
                cashback_amount = Math.round(cash * 0.01);
            } else if (mode === 'balakovo') {
                qr_price = Math.round(cash * 1.01505 / 100) * 100 - 10;
                card_price = Math.round(cash * 1.0305 / 100) * 100 - 10;
                rassrochka_price_six = Math.round(cash * 1.0705 / 100) * 100 - 10;
                rassrochka_price_ten = Math.round(cash * 1.1005 / 100) * 100 - 10;
                credit_price = Math.round(cash * 1.1805 / 100) * 100 - 10;
                cashback_amount = Math.round(cash * 0.01);
            }
